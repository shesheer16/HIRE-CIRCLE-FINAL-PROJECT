...
const ROLE_GROUPS = Object.freeze([
    ...
    {
        label: 'Campus & Student Gigs',
        hint: 'Student for student work, campus reps, project buddies, and college gigs',
        algorithmTags: ['CAMPUS_GIG'],
        roles: [
            makeRole({
                title: 'Student Assistant',
                aliases: ['Campus Assistant', 'Student Helper'],
                skills: ['Coordination', 'Communication', 'Basic Admin', 'Event Help'],
                certifications: [],
            ...
            makeRole({
                title: 'Project Buddy',
                aliases: ['Study Buddy', 'Project Assistant'],
                skills: ['Research', 'Coding basics', 'Documentation', 'Teamwork'],
                certifications: [],
                suggestedSalary: 8000,
                languageHints: ['English', 'Telugu'],
            }),
            makeRole({
                title: 'Campus Ambassador',
                aliases: ['Student Rep', 'College Promoter'],
                skills: ['Networking', 'Social Media', 'Marketing', 'Communication'],
                certifications: [],
                suggestedSalary: 10000,
                languageHints: ['English', 'Telugu'],
            }),
            makeRole({
                title: 'Student Freelancer',
                aliases: ['Campus Freelancer', 'Student Creator'],
                skills: ['Design', 'Writing', 'Video Editing', 'Social Media'],
                certifications: [],
            ...
            makeRole({
                ...
                aliases: ['Campus Event Staff', 'Volunteer'],
                skills: ['Crowd control', 'Registration', 'Setup', 'Energy'],
                certifications: [],
                suggestedSalary: 3000,
                languageHints: ['English', 'Telugu'],
            }),
        ],
    },
