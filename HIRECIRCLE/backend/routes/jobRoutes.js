...
router.delete('/my-jobs/all', protect, employer, deleteAllEmployerJobs);
router.get('/:id/insights', protect, employer, getEmployerJobInsights);
router.get('/:id', protect, enforceJobReadProtection, getJobById);
